...
:: Android packaging
set AND_CERT_NAME="StarlingGraphics"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingGraphics.p12
...
set IOS_PROVISION=cert\StarlingGraphics.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=StarlingGraphics
